    ...
    public partial class initialize : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriesLookup", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkPostingDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoriesLookupID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.CategoriesLookupID,
                        principalTable: "CategoriesLookup",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_LinkCategories_Links_LinksID",
                        column: x => x.LinksID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LinkImages", x => x.ID);
                    table.ForeignKey(
                        name: "FK_LinkImages_Links_LinksID",
                        column: x => x.LinksID,
                        principalTable: "Links",
                        principalColumn: "ID");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LinkCategories_LinksID",
                table: "LinkCategories",
                column: "LinksID");

            migrationBuilder.CreateIndex(
                name: "IX_LinkImages_LinksID",
                table: "LinkImages",
                column: "LinksID");
        }
